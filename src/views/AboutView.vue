	...
	<section class="page-section page-section_skew_no">
		<div class="page-section__container page-section__container--about">
			...
			<div class="page-section__text page-section__text--about">
				<p class="text text--mgb-34 text--mgb-sm-32 text--mgb-md-36 text--ls-26 text--md-size-lg">Мы верим, что
					онлайн-платежи могут быть <a href="https://arsenalpay.ru/tariffs.html" class="link link--in-text" target="_blank"
												 rel="noopener noreferrer">прозрачными</a> для бизнеса и удобными для <a href="https://arsenalpay.ru/developers.html"
																														 class="link link--in-text" target="_blank" rel="noopener noreferrer">разработчиков.</a></p>
			</div>
