		...
		<section class="page-section page-section_order_5">
			<div class="page-section__container">
				...
				<p class="text text_level_1">
					...
					пробиваются с&nbsp;полной номенклатурой, в&nbsp;соответствии с&nbsp;последними изменениями 54‑ФЗ.
					...
					Мгновенно отправляются через ОФД в&nbsp;налоговую и&nbsp;на&nbsp;email вашего клиента. Теперь
					у&nbsp;вас будут чеки по&nbsp;всем&nbsp;заказам.
				</p>
			</div>
		</section>
			...
			<div class="page-section__container">
				...
				<div class="page-section__box page-section__box_type_one">
					...
					<p class="text text_level_3 text_mgb_60 text_lh_28.on_screen_md text_mgb_80.on_screen_md">
						...
						отпечатком пальца — Touch ID, или через распознавание лица — Face ID.<br
							class="br br--show-lg"
						/>
			...
			<div class="page-section__container">
				...
				<p class="text text_level_1">
					...
					Вы&nbsp;платите только за&nbsp;успешные платежи и&nbsp;экономите 50&nbsp;000&nbsp;₽ в&nbsp;год.<br
						class="br br--show-lg"
					/>
					<b class="text text_weight_bold text_color_pink text_display_inline"> Бесплатные опции</b
					>&nbsp;&mdash; онлайн касса, выставление счёта, возврат платежа, холдирование платежей, кнопки
					WhatsApp, Telegram, Viber, мультиссылка, автоматическая email&nbsp;рассылка.
				</p>
				<div class="page-section__row">
					<div class="page-section__col">
